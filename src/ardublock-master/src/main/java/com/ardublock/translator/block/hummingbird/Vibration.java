...
public class Vibration extends TranslatorBlock {

	public Vibration(Long blockId, Translator translator, String codePrefix,
	...
	public String toCode() throws SocketNullException,
		...
		String ret = "bird.setVibration("+PortNum+","+IntensityNum+");";
